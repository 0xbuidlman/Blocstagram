...
- (UIImage *)imageByScalingToSize:(CGSize)size andCroppingWithRect:(CGRect)rect {
    UIImage *imageToReturn = [self imageResizedToMatchAspectRatioOfSize:size];
    imageToReturn = [imageToReturn imageCroppedToRect:rect];
    return [imageToReturn imageWithFixedOrientation];
}
