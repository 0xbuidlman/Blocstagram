...
@property (nonatomic) AFHTTPRequestOperationManager *instagramOperationManager; // property for Request Mgr
@end
...
- (void)parseDataFromFeedDictionary:(NSDictionary *) feedDictionary fromRequestWithParameters:(NSDictionary *)parameters {
    ...
    if (tmpMediaItems.count > 0) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            NSArray *mediaObjectsToSave = [self.mediaItems subarrayWithRange:NSMakeRange(0, numberOfItemsToSave)];
            
            NSString *fullPath = [self pathForFilename:NSStringFromSelector(@selector(mediaItems))];
            NSData *mediaItemData = [NSKeyedArchiver archivedDataWithRootObject:mediaObjectsToSave];
                                    ...
                                    success:^(AFHTTPRequestOperation *operation, id responseObject) {
                                        ...
                                        if ([error.domain isEqualToString:NSURLErrorDomain]) {
                                            ...
                                            if (error.code == NSURLErrorTimedOut ||
                                                ...
                                                // Try it again next time - it might work
...
#pragma mark - NSKeyedArchiver Support Methods
